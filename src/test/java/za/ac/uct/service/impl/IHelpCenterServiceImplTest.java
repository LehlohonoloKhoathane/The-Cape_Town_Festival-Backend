...
import za.ac.uct.factory.impl.HelpCenterFactory;
...
class IHelpCenterServiceImplTest {
    ...
    private static HelpCenter helpCenter2 = HelpCenterFactory.createHelpCenter(
            ...
            "To book an event, select the desired event from the list, choose the RSVP dates, and proceed to checkout.",
            LocalDateTime.now(), LocalDateTime.now());
    ...
    private static HelpCenter helpCenter7 = HelpCenterFactory.createHelpCenter(
            ...
            "To view your RSVP history, go to your profile page and click on the 'Rental History' tab.",
            LocalDateTime.now(), LocalDateTime.now());
    ...
    private static HelpCenter helpCenter9 = HelpCenterFactory.createHelpCenter(
            ...
            "To extend a RSVP, go to your RSVP history and click on the 'Extend Rental' button next to the reservation.",
            LocalDateTime.now(), LocalDateTime.now());
    ...
    private static HelpCenter helpCenter11 = HelpCenterFactory.createHelpCenter(
            ...
            "When booking a event, you can select pickup and drop-off locations on the booking form.",
            LocalDateTime.now(), LocalDateTime.now());
