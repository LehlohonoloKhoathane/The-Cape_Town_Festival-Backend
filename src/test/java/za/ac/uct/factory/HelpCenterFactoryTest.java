...
//        HelpCenter helpCenter2 = factory.createHelpCenter(2, "Booking", "How to Book a Event", "To book a event, select the desired event from the list, choose the RSVP dates, and proceed to checkout.", LocalDateTime.now(), LocalDateTime.now());
