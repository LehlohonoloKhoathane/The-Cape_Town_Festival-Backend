...
import za.ac.uct.factory.impl.DamageReportFactory;
import za.ac.uct.service.impl.DamageReportServiceImpl;
...
public class AdminDamageReportController {
    ...
    public ResponseEntity<DamageReport> create(@RequestBody DamageReport damageReport){
        ...
        // Check if the RSVP ID provided in the damage report already exists
       /** if (rentalService.existsById(damageReport.getRental().getId())) {
            ...
            // Handle the case where the provided RSVP ID doesn't exist
